...
This project is an introduction to Terraform Infrastructure as Code (IaC).
In this project, Terraform was used to provision cloud resources automatically instead of creating them manually in the AWS console.
